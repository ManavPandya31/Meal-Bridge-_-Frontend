    ...
    <footer className="bg-gray-900 text-white py-8 w-full overflow-hidden">
      <div className="container mx-auto px-4 flex flex-col md:flex-row justify-between items-center text-center md:text-left">
        ...
        <nav className="mt-4 md:mt-0 flex flex-wrap justify-center space-x-4 md:space-x-6 text-sm w-full md:w-auto">
          <Link to="/" className="hover:text-green-400 no-underline">
            Home
          </Link>
          <Link to="/about-us" className="hover:text-green-400 no-underline">
            About Us
          </Link>
          <Link to="/login" className="hover:text-green-400 no-underline">
            Login
          </Link>
          <Link to="/signup" className="hover:text-green-400 no-underline">
            Sign Up
          </Link>
        </nav>
